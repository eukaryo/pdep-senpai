...
//	uint64_t dst = 0;
//
//	for (uint64_t m = 0; mask; mask /= 256, m += 8) {
//		const uint64_t b = mask % 256;
//		dst += ((uint64_t)table_256_256[a % 256][b]) << m;
//		a >>= table_256_256_popcnt[b];
//	}
//
//	return dst;
//}
...
//	for (uint64_t m = 0; mask; mask /= 16, m += 4) {
//		const uint64_t b = mask % 16;
//		dst += ((uint64_t)table_16_16_inv[b][a % 16]) << m;
//		a >>= table_16_16_popcnt[b];
//	}
//
//	return dst;
...
//	for (uint64_t m = 0; mask; mask /= 256, m += 8) {
//		const uint64_t b = mask % 256;
//		dst += ((uint64_t)table_256_256_inv[b][a % 256]) << m;
//		a >>= table_256_256_popcnt[b];
//	}
//
//	return dst;
